...
[bg storage="シェアハウスリビング.jpg" time="100"]
...
;キャラクターの名前が表示される文字領域
[ptext name="chara_name_area" layer="message0" color="white" size=50 bold=true x=180 y=800]
...
[glink  color="blue"  storage="scene1.ks"  size="28"  x="710"  width="500"  y="150"  text="はい。興味あります"  target="*selectinterest"  ]
[glink  color="blue"  storage="scene1.ks"  size="28"  x="710"  width="500"  y="250"  text="興味あります！"  target="*selectinterest"  ]
[glink  color="blue"  storage="scene1.ks"  size="28"  x="710"  width="500"  y="350"  text="どちらかと言うと興味あり"  target="*selectinterest"  ]
[s  ]
*selectinterest
